  ...
  <view class="content pagebg">
    <view class="newsType comNews">
      ...
      >
        ...
        <view class="btn delete float-right">删除</view>
        <view class="btn look float-right">查看</view>
      </view>
    </view>
  </view>
</template>
...
export default {
  data() {
    return {
      itemstyle: "left:0;",
      dataList: [{ style: "left:0;", style: "left:0;" }],
      t_x: 0,
      t_y: 0
    };
  },
